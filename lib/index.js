...
program
    ...
    console.log('\n🤖 ' + chalk_1.default.bold('AI Providers (Primary: ChatGPT → Fallback: Gemini → Copilot):'));
    console.log(chalk_1.default.yellow('   OPENAI_API_KEY') + '=your-openai-api-key ' + chalk_1.default.gray('(recommended)'));
    console.log(chalk_1.default.yellow('   GEMINI_API_KEY') + '=your-gemini-api-key ' + chalk_1.default.gray('(fallback)'));
    console.log(chalk_1.default.yellow('   COPILOT_API_TOKEN') + '=your-copilot-api-token ' + chalk_1.default.gray('(legacy)\n'));
...
program
    ...
    try {
        ...
        const setupScript = path_1.default.join(__dirname, '..', 'scripts', 'setup-git-extension.js');
        const setupProcess = (0, child_process_1.spawn)('node', [setupScript], {
            stdio: 'inherit',
            shell: true
        });
