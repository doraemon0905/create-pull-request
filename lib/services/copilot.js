...
class CopilotService {
    ...
    async generateSummary(options, provider) {
        ...
        if (template) {
            ...
            summaryPrompt += `${template.content.substring(0, constants_1.LIMITS.MAX_TEMPLATE_PREVIEW_LENGTH)}${template.content.length > constants_1.LIMITS.MAX_TEMPLATE_PREVIEW_LENGTH ? '...' : ''}\n`;
