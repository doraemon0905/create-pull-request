...
sed -i.tmp 's/"name": "create-pull-request"/"name": "@doraemon0905\/create-pull-request"/' package.json
...
echo "Your package is now available at: https://github.com/doraemon0905/create-pull-request/packages"
